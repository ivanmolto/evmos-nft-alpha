      ...
      <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block xl:inline">NFT discovery</span>{" "}
            <span className="block text-eorange xl:inline">made easy</span>
          </h1>
            ...
            >
              ...
              <div className="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  Open and free EVM on-chain data from Covalent
                  <br />
            ...
            >
              ...
              <div className="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  ...
                  Profile NFT collections, items and wallets.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                ...
                <p className="mt-2 text-sm text-gray-500">
                  ...
                  <br />
                  Perform due diligence on the Evmos NFT ecosystem.
                </p>
              </div>
            </div>
          </div>
